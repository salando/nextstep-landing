...
const TASKS: Task[] = [
  { id: '1', title: 'Motor Research', status: 'completed', priority: 'critical', detail: 'Completed Nov 21: Specs analysis & selection.' },
  { id: '2', title: 'Component Selection', status: 'completed', priority: 'high', detail: 'Full BOM created (Power, Control, Safety).' },
  { id: '3', title: 'Parts Sourcing', status: 'active', priority: 'high', detail: 'Ordering vendors & logistics (Due Nov 23).' },
  { id: '4', title: 'Battery Calculations', status: 'pending', priority: 'critical', detail: 'Runtime & discharge analysis (Due Nov 26).' },
  { id: '5', title: 'Battery Wiring', status: 'backlog', priority: 'medium', detail: 'BMS implementation & safety circuits (Dec 7).' },
